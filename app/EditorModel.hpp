...
private:
    ...
    std::vector<Command*> undoTracker;
    // delete/clear the redo vector of commands when anything other than undo happens
    std::vector<Command*> redoTracker;
